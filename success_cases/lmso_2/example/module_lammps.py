...
bond_dict  = {}
bond_dict['Ti-O'] = 1.880/(2**(1/6))
bond_dict['P-O']  = 1.530/(2**(1/6))
bond_dict['O-Ti'] = 1.880/(2**(1/6))
bond_dict['O-P']  = 1.530/(2**(1/6))

second_dict  = {}
second_dict['Ti-O'] = 3.3 
second_dict['P-O']  = 3.3
second_dict['O-Ti'] = 3.3
second_dict['O-P']  = 3.3
  ...
  for cation in cation_dict:
   ...
   for anion in c_dict:
    ...
    if [anion,cation] not in pair_lists and [cation,anion] not in pair_lists:
     ...
     lfile.write(f"pair_coeff {cation+1} {anion+1} lj/cut 1.5 {bond} 6.0\n") 
